...
class Porto_Functionality {
	...
	public function script_add_async_attribute( $tag, $handle ) {
		...
		$scripts_to_async = array( 'jquery-magnific-popup', 'porto-theme-async', 'porto-video-api', 'porto-post-ajax-modal', 'porto-portfolio-async', 'porto-member-async', 'jquery-flipshow', 'porto_shortcodes_flipshow_loader_js' );
	...
	protected function define_constants( $active_plugins ) {
		...
		define( 'PORTO_FUNC_VERSION', '3.3.0' );
