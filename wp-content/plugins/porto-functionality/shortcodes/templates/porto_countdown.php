...
$count_arr = array();
if ( $tick_size ) {
	$count_arr['tick_size'] = $tick_size;
}
if ( $tick_line_height ) {
	$count_arr['tick_line_height'] = $tick_line_height;
}
if ( $tick_sep_size ) {
	$count_arr['tick_sep_size'] = $tick_sep_size;
}
if ( $tick_sep_line_height ) {
	$count_arr['tick_sep_line_height'] = $tick_sep_line_height;
}
if ( $tick_col ) {
	$count_arr['tick_col'] = $tick_col;
}
if ( $tick_sep_col ) {
	$count_arr['tick_sep_col'] = $tick_sep_col;
}
if ( $tick_style ) {
	$count_arr['tick_style'] = $tick_style;
}
if ( $tick_sep_style ) {
	$count_arr['tick_sep_style'] = $tick_sep_style;
}

$count_down_id = 'count-down-wrap-' . hash( 'md5',  json_encode( $count_arr ) );
