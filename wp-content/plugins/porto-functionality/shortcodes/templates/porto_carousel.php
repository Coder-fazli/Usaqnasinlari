...
$options['items']              = floatval( $items );
$options['xl']                 = floatval( $items );
$options['lg']                 = floatval( $items_lg );
$options['md']                 = floatval( $items_md );
$options['sm']                 = floatval( $items_sm );
$options['xs']                 = floatval( $items_xs );
