...
class Porto_Elementor_Page_Header_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eicon-product-breadcrumbs porto-elementor-widget-icon';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				'type'      => Controls_Manager::COLOR,
				'label'     => __( 'Breadcrumbs Link Hover Color', 'porto-functionality' ),
				'selectors' => array(
					'{{WRAPPER}} .breadcrumbs-wrap a:hover' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'hide_breadcrumb' => '',
				),
