	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}:hover .porto-sicon-title, {{WRAPPER}}:hover .porto-icon, {{WRAPPER}}:hover .porto-sicon-img, {{WRAPPER}}:hover .porto-sicon-description, {{WRAPPER}}:hover .porto-sicon-header p' => 'color: {{VALUE}};',
					'.elementor-element-{{ID}} .porto-sicon-title, .elementor-element-{{ID}} .porto-sicon-header p, .elementor-element-{{ID}} .porto-sicon-description'       => 'transition: color .3s;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'   => array(
					'.elementor-element-{{ID}} .porto-sicon-img.porto-u-circle-img:before' => 'border-color: {{VALUE}};',
					'.elementor-element-{{ID}} .porto-sicon-img' => 'background: {{VALUE}};',
					'.elementor-element-{{ID}} .porto-icon'      => 'background: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'   => array(
					'.elementor-element-{{ID}}:hover .porto-sicon-img.porto-u-circle-img:before' => 'border-color: {{VALUE}};',
					'.elementor-element-{{ID}}:hover .porto-sicon-img' => 'background: {{VALUE}};',
					'.elementor-element-{{ID}}:hover .porto-icon'      => 'background: {{VALUE}};',
				),
			)
		);		
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'read_more' => array( 'title' ),
				),
				'selectors' => array(
					'{{WRAPPER}} .porto-sicon-title:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .porto-sicon-title'       => 'transition: color .3s;',
				),
			)
		);
