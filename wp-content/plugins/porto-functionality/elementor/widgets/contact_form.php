...
class Porto_Elementor_Contact_Form_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eicon-form-horizontal porto-elementor-widget-icon';
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '.elementor-element-{{ID}}, .elementor-element-{{ID}} input, .elementor-element-{{ID}} select, .elementor-element-{{ID}} textarea',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'.elementor-element-{{ID}} input[type="text"], .elementor-element-{{ID}} input[type="email"], .elementor-element-{{ID}} input[type="date"], .elementor-element-{{ID}} input[type="datetime"], .elementor-element-{{ID}} input[type="number"], .elementor-element-{{ID}} input[type="tel"], .elementor-element-{{ID}} select' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
