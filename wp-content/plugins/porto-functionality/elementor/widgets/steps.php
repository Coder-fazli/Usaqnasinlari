...
class Porto_Elementor_Steps_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eicon-history porto-elementor-widget-icon';
	}
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'.elementor-element-{{ID}} .process-horizontal .process-step' => '--porto-step-circle-wd: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'.elementor-element-{{ID}} .process-horizontal .process-step-circle' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'.elementor-element-{{ID}} .process-horizontal' => '--porto-step-circle-margin:{{TOP}}{{UNIT}}',
				),
			)
		);
