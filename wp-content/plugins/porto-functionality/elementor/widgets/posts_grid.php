	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '4',
				'options'   => array_flip( porto_sh_commons( 'products_columns' ) ),
				'condition' => array(
					'view!' => 'creative',
				),
			)
		...
		$this->add_responsive_control(
			...
			array(
				'type'        => Controls_Manager::SELECT,
				'label'       => __( 'Add Half Column', 'porto-functionality' ),
				'options'   => array(
					''    => '',
				...
				'devices'     => array( 
					Elementor\Core\Breakpoints\Manager::BREAKPOINT_KEY_DESKTOP,
