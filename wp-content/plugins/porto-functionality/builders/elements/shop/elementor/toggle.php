...
class Porto_Elementor_SB_Toggle_Widget extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'Simple-Line-Icons-grid porto-elementor-widget-icon';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors'   => array(
					'.elementor-element-{{ID}} a:not(.active)' => 'color: {{VALUE}}; border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => array(
					'.elementor-element-{{ID}} .active' => 'color: {{VALUE}}; border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'bd',
				'selector' => '.elementor-element-{{ID}} div.gridlist-toggle > a',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'.elementor-element-{{ID}} div.gridlist-toggle > .active' => 'border-color: {{VALUE}};',
				),
				'condition' => array(
					'bd_border!' => '',
				),
