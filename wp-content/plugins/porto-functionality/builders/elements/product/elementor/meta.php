...
class Porto_Elementor_CP_meta_Widget extends \Elementor\Widget_Base {
	...
	public function get_keywords() {
		return array( 'product', 'meta', 'category', 'tag', 'vendor', 'dokan', 'wcfm', 'gtin', 'global unique id', 'sku' );
	}

	public function get_icon() {
		return 'eicon-product-meta porto-elementor-widget-icon';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'raw'             => sprintf(__('You can change meta values in %1$sPorto / Theme Options / WooCommerce / Single Product / Show Product Meta%2$s.', 'porto-functionality'), '<a href="' . porto_get_theme_option_url('product-metas') . '" target="_blank" class="porto-text-underline">', '</a>'),
		...
		$this->add_control(
			...
			array(
				...
				'selectors'   => array(
					'.elementor-element-{{ID}} .product_meta' => 'display: {{VALUE}}; flex-wrap: wrap;',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.elementor-element-{{ID}} .product_meta, .product-summary-wrap  .elementor-element-{{ID}} .product_meta span' => 'color: {{VALUE}};',
				),
				'separator' => 'before',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '.elementor-element-{{ID}} .product_meta, .product-summary-wrap  .elementor-element-{{ID}} .product_meta span',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.product-summary-wrap .elementor-element-{{ID}} .product_meta a, .elementor-element-{{ID}} .product_meta a' => 'color: {{VALUE}};',
				),
				'separator' => 'before',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '.elementor-element-{{ID}} .product_meta a, .product-summary-wrap  .elementor-element-{{ID}} .product_meta a',
			)
		);
