...
//   global $product;
//   echo '<a class="fazli" href="https://api.whatsapp.com/send?phone=+99455 250 19 97&amp;text=Salam! sualım var :)">WHATSAPPLA Sifariş</a>';
// }
...
function cmk_additional_button() {
    echo '<a class="fazl"href="https://api.whatsapp.com/send?phone=+994517730395&amp;text=Salam! sualım var :)">WHATSAPPLA Sifariş</a>';
}

// To change add to cart text on single product page
add_filter( 'woocommerce_product_single_add_to_cart_text', 'woocommerce_custom_single_add_to_cart_text' ); 
function woocommerce_custom_single_add_to_cart_text() {
    return __( 'Səbətə At', 'woocommerce' ); 
}
